        ...
        <div>
          ...
          <div className="space-y-4 text-muted-foreground leading-relaxed">
            <p>
              ...
              innovative startups to established enterprises, always focusing on
              quality and attention to detail.
            </p>
            <p>
              With years of experience in the industry, we've developed a unique
              approach that combines cutting-edge technology with timeless
              design principles. Every project is an opportunity to push
